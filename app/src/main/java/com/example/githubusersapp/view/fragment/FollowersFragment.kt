...
class FollowersFragment : Fragment() {
    ...
    private fun setData(username: String?) {
        myViewModel.setUserFollowers(username.toString())
        loadData()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_user_followers.setHasFixedSize(true)
        rv_user_followers.layoutManager = LinearLayoutManager(context)
        rv_user_followers.adapter = listAdapter
